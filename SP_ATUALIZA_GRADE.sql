...
BEGIN
    ...
    EXCEPTION    
        ...
        WHEN CURSO_ID_INVALIDO THEN
            RAISE_APPLICATION_ERROR(-20001, 'CODIGO ID DO CURSO INVÁLIDO! - ' || SQLERRM);
            
        WHEN NO_DATA_FOUND THEN
            RAISE_APPLICATION_ERROR(-20002, 'CODIGO ID DO CURSO INVÁLIDO! - ' || SQLERRM);
    ...
    EXCEPTION    
        ...
        WHEN MATERIA_ID_INVALIDO THEN
            RAISE_APPLICATION_ERROR(-20003, 'CODIGO ID DA MATERIA INVÁLIDO! - ' || SQLERRM);
            
        WHEN NO_DATA_FOUND THEN
            RAISE_APPLICATION_ERROR(-20004, 'CODIGO ID DA MATERIA INVÁLIDO! - ' || SQLERRM);
    ...
    EXCEPTION    
        ...
        WHEN ALUNO_ID_INVALIDO THEN
            RAISE_APPLICATION_ERROR(-20005, 'CODIGO ID DE ALUNO INVÁLIDO! - ' || SQLERRM);
            
        WHEN NO_DATA_FOUND THEN
            RAISE_APPLICATION_ERROR(-20006, 'CODIGO ID DE ALUNO INVÁLIDO! - ' || SQLERRM);
    ...
    EXCEPTION    
        ...
        WHEN PK_GRADE_INVALIDA THEN
            RAISE_APPLICATION_ERROR(-20007, 'CURSO, MATERIA E ALUNO JÁ CADASTRATO NA GRADE! - ' || SQLERRM);
