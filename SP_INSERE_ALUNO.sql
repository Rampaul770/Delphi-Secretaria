...
BEGIN
    ...
    EXCEPTION    
        ...
        WHEN RA_INVALIDO THEN
            RAISE_APPLICATION_ERROR(-20002, 'CODIGO DO RA INVÁLIDO!');
    ...
    EXCEPTION
        ...
        WHEN ENDERECO_INVALIDO THEN
            RAISE_APPLICATION_ERROR(-20004, 'ENDERECO INVÁLIDO!');
    ...
    EXCEPTION    
        ...
        WHEN CEP_INVALIDO THEN
            RAISE_APPLICATION_ERROR(-20005, 'CODIGO DO CEP INVÁLIDO!');
    ...
    EXCEPTION    
        ...
        WHEN TELEFONE_INVALIDO THEN
            RAISE_APPLICATION_ERROR(-20007, 'TELEFONE INVÁLIDO!');
    ...
    EXCEPTION    
        ...
        WHEN CELULAR_INVALIDO THEN
            RAISE_APPLICATION_ERROR(-20009, 'CELULAR INVÁLIDO!');
