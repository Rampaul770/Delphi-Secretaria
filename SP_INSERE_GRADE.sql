...
BEGIN
    ...
    EXCEPTION    
        ...
        WHEN ALUNO_ID_INVALIDO THEN
            RAISE_APPLICATION_ERROR(-20004, 'CÓDIGO ID DE ALUNO INVÁLIDO!');
    ...
    EXCEPTION
        ...
        WHEN NO_DATA_FOUND THEN
            RAISE_APPLICATION_ERROR(-20005, 'CÓDIGO ID DE MATÉRIA OU CURSO INVÁLIDOS!');
            
    END;
    
    BEGIN
    
        SELECT DISTINCT ID INTO V_ID
        FROM GRADE
        WHERE NOME = P_NOME;
    ...
    EXCEPTION
        ...
        WHEN NO_DATA_FOUND THEN
           SELECT SQ_GRADE.NEXTVAL INTO V_ID FROM DUAL;
    ...
    BEGIN
        ...
        VALUES(V_ID, P_NOME, V_CURSO_MATERIA_ID, P_ALUNO_ID);
    ...
    EXCEPTION
        ...
        WHEN DUP_VAL_ON_INDEX THEN
            BEGIN
                ROLLBACK;
                RAISE_APPLICATION_ERROR(-20006, 'CURSO, MATÉRIA E ALUNO ESPECIFICADO JÁ CADASTRADOS PARA ESSA GRADE!');
            END;
