...
DROP TABLE MATERIA_CURSO CASCADE CONSTRAINTS ;
...
CREATE TABLE GRADE
  (
    ID               NUMBER (5) NOT NULL ,
    NOME             VARCHAR2 (20) ,
    MATERIA_CURSO_ID NUMBER (5) NOT NULL ,
    ALUNO_ID         NUMBER (5) NOT NULL
  ) ;
ALTER TABLE GRADE ADD CONSTRAINT GRADE_PK PRIMARY KEY ( ID ) ;
ALTER TABLE GRADE ADD CONSTRAINT GRADE__UN UNIQUE ( ALUNO_ID , MATERIA_CURSO_ID ) ;
...
ALTER TABLE MATERIA_CURSO ADD CONSTRAINT MATERIA_CURSO_PK PRIMARY KEY ( ID ) ;
ALTER TABLE MATERIA_CURSO ADD CONSTRAINT MATERIA_CURSO__UN UNIQUE ( CURSO_ID , MATERIA_ID ) ;


ALTER TABLE GRADE ADD CONSTRAINT GRADE_ALUNO_FK FOREIGN KEY ( ALUNO_ID ) REFERENCES ALUNO ( ID ) ;

ALTER TABLE GRADE ADD CONSTRAINT GRADE_MATERIA_CURSO_FK FOREIGN KEY ( MATERIA_CURSO_ID ) REFERENCES MATERIA_CURSO ( ID ) ;

ALTER TABLE MATERIA_CURSO ADD CONSTRAINT MATERIA_CURSO_CURSO_FK FOREIGN KEY ( CURSO_ID ) REFERENCES CURSO ( ID ) ;

ALTER TABLE MATERIA_CURSO ADD CONSTRAINT MATERIA_CURSO_MATERIA_FK FOREIGN KEY ( MATERIA_ID ) REFERENCES MATERIA ( ID ) ;


DROP SEQUENCE SQ_ALUNO;
DROP SEQUENCE SQ_CURSO;
DROP SEQUENCE SQ_MATERIA;
DROP SEQUENCE SQ_MATERIA_CURSO;
...
CREATE SEQUENCE SQ_MATERIA_CURSO
MINVALUE 1
MAXVALUE 1000
INCREMENT BY 1
START WITH 1
