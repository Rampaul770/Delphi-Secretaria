...
begin
  ...
  try
    ...
    if Retorno = '' then
      MessageBox(FrmMateriaCadastro.Handle, 'Matéria cadastrada com sucesso!', 'Aviso', MB_OK or MB_ICONINFORMATION)
    else
      MessageBox(FrmMateriaCadastro.Handle, PChar('Falha ao cadastrar a matéria!' + Char(13)  + Char(13) + 'Erro: ' + Retorno), 'Erro', MB_OK or MB_ICONSTOP);
...
begin
  ...
  try
    ...
    if Retorno = '' then
      ...
      MessageBox(FrmMateriaCadastro.Handle, PChar('Falha ao atualizar o cadastro da matéria!' + Char(13)  + Char(13) + 'Erro: ' + Retorno), 'Erro', MB_OK or MB_ICONSTOP);
